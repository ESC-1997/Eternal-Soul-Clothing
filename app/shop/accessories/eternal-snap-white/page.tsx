...
export default function EternalSnapWhitePage() {
    ...
    const fetchProduct = async () => {
      try {
        ...
        const snap = products.find((p: any) => {
          ...
          return normalizedTitle === 'theeternalsnap-white'.toLowerCase();
        });
              ...
              <div className="text-white">
                ...
                <div className="mt-8">
                  ...
                  <p className="text-gray-300">
                    The Eternal Snap - White is a premium snapback hat that embodies the essence of Eternal Soul's design philosophy. 
                  ...
                  <ul className="list-disc list-inside text-gray-300 mt-4 space-y-2">
                    ...
                    <li>Clean white base with contrasting details</li>
