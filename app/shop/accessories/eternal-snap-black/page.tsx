...
export default function EternalSnapBlackPage() {
    ...
    const fetchProduct = async () => {
      try {
        ...
        const snap = products.find((p: any) => {
          ...
          return normalizedTitle === 'theeternalsnap-black'.toLowerCase();
        });
          ...
          <div className="pt-24 px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="text-white">
                ...
                <p className="text-2xl mb-6">${selectedVariantData?.price}</p>
                ...
                <div className="mt-8">
                  ...
                  <p className="text-gray-300">
                    The Eternal Snap - Black is a premium snapback hat that embodies the essence of Eternal Soul's design philosophy. 
                  ...
                  <ul className="list-disc list-inside text-gray-300 mt-4 space-y-2">
                    ...
                    <li>Clean black base with contrasting details</li>
