  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        const phoneCase = products.find((p: any) => 
          p.title.toLowerCase().includes('gothic tough phone cases')
        );
        ...
        if (phoneCase) {
          setProduct({
            ...
            images: phoneCase.images.map((img: any) => ({ src: img.src })),
            variants: phoneCase.variants.map((variant: any) => ({
              id: variant.id,
              title: variant.title,
              price: (variant.price / 100).toFixed(2)
            }))
          });
          if (phoneCase.variants.length > 0) {
            setSelectedVariant(phoneCase.variants[0].id);
          }
        }
      } catch (err) {
            ...
            <div className="text-white">
              ...
              <div className="mt-8">
                ...
                <p className="text-gray-300">
                  Protect your device with our Gothic Tough Phone Cases, featuring the iconic Eternal Soul design. 
                  These premium cases combine style with durability, offering:
                </p>
                <ul className="list-disc list-inside text-gray-300 mt-4 space-y-2">
                  <li>Military-grade drop protection</li>
                  <li>Raised edges to protect screen and camera</li>
                  <li>Anti-slip grip for secure handling</li>
