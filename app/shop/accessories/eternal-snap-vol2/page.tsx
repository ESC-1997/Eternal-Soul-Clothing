              ...
              <div className="text-white">
                ...
                <div className="mt-8">
                  ...
                  <p className="text-gray-300">
                    The Eternal Snap (Vol.2) is a premium snapback hat that embodies the essence of Eternal Soul's design philosophy. 
                  ...
                  <ul className="list-disc list-inside text-gray-300 mt-4 space-y-2">
                    ...
                    <li>Bold black design on premium material</li>
