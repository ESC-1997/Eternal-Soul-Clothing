...
export default function EternalVibeLeggingsGreyPage() {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        // Find the grey leggings product by exact ID
        const foundProduct = products.find((p: any) => 
          p.id === '683763a0ced8bcc1e60d3a62'  // Grey leggings product ID
        );
        
        if (!foundProduct) {
          throw new Error('Grey leggings product not found');
        }
          ...
          <div className="text-white space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-300">
                The Eternal Vibe Women's Casual Leggings in Grey combine comfort and style for your everyday active lifestyle. 
