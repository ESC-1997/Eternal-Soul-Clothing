...
export default function BikerShortsCharmPinkPage() {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        // Find the charm pink biker shorts product
        const foundProduct = products.find((p: any) => 
          p.title.toLowerCase().includes('biker shorts') && 
          p.title.toLowerCase().includes('charm pink')
        );
        
        if (!foundProduct) {
          throw new Error('Charm pink biker shorts product not found');
        }
        ...
        const transformedProduct: Product = {
          ...
          description: foundProduct.description || 'The Eternal Motion Biker Shorts in Charm Pink combine style and performance for your active lifestyle. These high-waisted shorts feature a sleek, modern design with a comfortable, stretchy fit. The moisture-wicking fabric keeps you dry during workouts, while the built-in liner provides extra support and coverage. Perfect for running, cycling, or any high-intensity workout.',
