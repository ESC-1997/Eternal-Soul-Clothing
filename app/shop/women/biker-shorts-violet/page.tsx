...
export default function BikerShortsVioletPage() {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        // Find the violet biker shorts product
        const foundProduct = products.find((p: any) => 
          p.title.toLowerCase().includes('biker shorts') && 
          p.title.toLowerCase().includes('violet')
        );
        
        if (!foundProduct) {
          throw new Error('Violet biker shorts product not found');
        }
          ...
          <div className="text-white space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-300">
                The Eternal Motion Biker Shorts in Violet combine style and performance for your active lifestyle. 
                These high-waisted shorts feature a sleek, modern design with a comfortable, stretchy fit. 
