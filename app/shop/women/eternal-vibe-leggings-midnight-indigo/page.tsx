...
export default function EternalVibeLeggingsMidnightIndigoPage() {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        // Find the midnight indigo leggings product by exact ID
        const foundProduct = products.find((p: any) => 
          p.id === '683763a0ced8bcc1e60d3a63'  // Midnight Indigo leggings product ID
        );
        
        if (!foundProduct) {
          throw new Error('Midnight Indigo leggings product not found');
        }
          ...
          <div className="text-white space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-300">
                The Eternal Vibe Women's Casual Leggings in Midnight Indigo combine comfort and style for your everyday active lifestyle. 
                These high-waisted leggings feature a sleek, modern design with a comfortable, stretchy fit. 
                The moisture-wicking fabric keeps you dry during workouts, while the four-way stretch provides 
                maximum flexibility. Perfect for yoga, running, or casual wear.
              </p>
            </div>
          </div>
        </div>
