...
export default function EternalLovePage() {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        const eternalLove = products.find((p: any) => p.title.toLowerCase().includes('eternal love'));
        ...
        const transformedProduct = {
          id: eternalLove.id,
          title: eternalLove.title,
          description: eternalLove.description || 'The Eternal Love collection embodies the essence of passion and devotion, crafted for those who wear their heart on their sleeve.',
          images: eternalLove.images.map((img: any) => ({ src: img.src })),
          variants: eternalLove.variants
