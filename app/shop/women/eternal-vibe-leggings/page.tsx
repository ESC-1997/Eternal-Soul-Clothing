...
export default function EternalVibeLeggingsPage() {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        if (!foundProduct) {
          throw new Error('Leggings product not found');
        }
          ...
          <div className="text-white space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-300">
                The Eternal Vibe Women's Casual Leggings combine comfort and style for your everyday active lifestyle. 
