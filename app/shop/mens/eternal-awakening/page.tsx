...
export default function EternalAwakeningPage() {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        // Find the Eternal Awakening product
        const eternalAwakening = products.find((p: any) => 
          p.title.toLowerCase().includes('eternal awakening')
        );
        ...
        const transformedProduct: Product = {
          ...
          description: "The Eternal Awakening collection represents a bold statement of style and individuality. Each piece is crafted with premium materials and features our distinctive design elements, creating a perfect blend of comfort and fashion-forward aesthetics. This collection is designed for those who seek to make a statement while maintaining everyday versatility.",
          images: eternalAwakening.images.map((img: any) => ({ src: img.src })),
          variants: eternalAwakening.variants
  ...
  return (
    <Suspense fallback={<div className="flex justify-center items-center h-64"><div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-gray-900"></div></div>}>
