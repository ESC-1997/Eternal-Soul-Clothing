 ...
 * - Variants ALWAYS come in "Size / Color" format from Printify
 * - First part (index 0) is ALWAYS the size
 * - Second part (index 1) is ALWAYS the color
 */
...
function ProductPageContent() {
  ...
  // Color to image mapping - ALWAYS include comments for each color
  const colorToImageMap: { [key: string]: number } = {
    'Color1': 0, // First color
    'Color2': 1, // Second color
    'Color3': 2, // Third color
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        // Update this to match your product's title
        const product = products.find((p: any) => 
          p.title.toLowerCase().includes('your product title here')
        );

        if (product) {
          // Debug logging for variant titles
          console.log('Product Variants from Printify:', product.variants.map((v: any) => ({
            title: v.title,
          ...
          const transformedProduct: Product = {
            ...
            images: [
              { src: '/images/your-product/image1.png' }, // Color1
              { src: '/images/your-product/image2.png' }, // Color2
              { src: '/images/your-product/image3.png' }, // Color3
